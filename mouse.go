...
func NewEventMouse(x, y int, btn ButtonMask, mod ModMask, motion bool, raw string) *EventMouse {
	return &EventMouse{t: time.Now(), x: x, y: y, btn: btn, mod: mod, motion: motion, raw: raw}
}
